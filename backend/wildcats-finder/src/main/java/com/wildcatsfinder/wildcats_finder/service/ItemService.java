...
public class ItemService {
    ...
    public List<ItemEntity> searchActiveItems(String keyword) {
        java.util.List<ItemStatus> activeStatuses = java.util.Arrays.asList(
                ItemStatus.LOST, ItemStatus.FOUND, ItemStatus.CLAIMED, ItemStatus.RETURNED
        );
        
        List<ItemEntity> results = new ArrayList<>();
        
        // Search by title
        results.addAll(itemRepository.findByItemTitleContainingIgnoreCaseAndStatusIn(keyword, activeStatuses));
        
        // Search by description
        results.addAll(itemRepository.findByItemDescContainingIgnoreCaseAndStatusIn(keyword, activeStatuses));
