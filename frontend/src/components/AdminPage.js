    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
        ...
        {pendingItems.length > 0 && (
          ...
          >
            You have {pendingItems.length}{" "}
            {pendingItems.length === 1 ? "item" : "items"} awaiting review
          </Alert>
        )}
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              {action === "approve" &&
                "This item will be published and visible to all users."}
              {action === "reject" &&
                "This item will be rejected and the reporter will be notified."}
              {action === "delete" &&
