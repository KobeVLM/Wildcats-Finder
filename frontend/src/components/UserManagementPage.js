...
import { Claim } from "./ClaimManagementPage";
...
export function UserManagementPage({
  ...
  const getUserStats = (userEmail) => {
    ...
    return {
      ...
      rejectionRate:
        userClaims.length > 0
          ? (rejectedClaims.length / userClaims.length) * 100
          : 0,
    };
  };
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Alert severity="warning" sx={{ mb: 3 }}>
        <strong>Admin Guidance:</strong> Monitor users with high rejection rates
        (above 50%) - they may be making false claims. Consider suspending
        repeat offenders.
      </Alert>
          ...
          <TableBody>
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((user) => {
                ...
                const isHighRisk =
                  stats.rejectionRate > 50 && stats.claimsMade > 2;
          ...
          {selectedUser && (
            <>
              <Alert severity="warning" sx={{ mb: 2 }}>
                ...
                {selectedUser.email}). Suspended users cannot log in or access
                the system.
              </Alert>
              <TextField
                fullWidth
                    ...
                    <>
                      ...
                      <Box
                        sx={{
                          p: 2,
                          bgcolor:
                            stats.rejectionRate > 50 ? "#fee2e2" : "#fef3c7",
                          borderRadius: 1,
                          flex: 1,
                          minWidth: 120,
                        }}
                      >
                        ...
                        <Typography
                          ...
                          sx={{
                            color:
                              stats.rejectionRate > 50 ? "#dc2626" : "#ea580c",
                          }}
                        >
                          {stats.rejectionRate.toFixed(0)}%
                        </Typography>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                  {(() => {
                    ...
                    const userClaims = claims
                      .filter(
                        (claim) => claim.claimantEmail === selectedUser.email
                      )
                      .slice(0, 3);
