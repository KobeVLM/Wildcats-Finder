  ...
  return (
    <>
      ...
      <div className="home-container">
        ...
        <p>Welcome to Wildcats Finder, a platform for reuniting students with their belongings.</p>
  ...
  {reports
    ...
    .map((report, index) => (
      <div key={index} className={`report-box ${report.type}`}>
        <span className="tag">
          {report.type === "lost" ? "Lost" : report.type === "found" ? "Found" : "Reunited"}
        </span>
      ...
      <div style={{ margin: "30px 60px" }}>
        ...
        <button onClick={() => handleNewPost("found")} style={{ marginLeft: 10 }}>
          Simulate + Found
        </button>
        <button onClick={() => handleNewPost("reunited")} style={{ marginLeft: 10 }}>
          Simulate + Reunited
        </button>
      </div>
    </>
