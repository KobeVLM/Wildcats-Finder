...
import { UserManagementPage, type UserProfile } from './UserManagementPage';
import type { Claim } from './ClaimManagementPage';
...
interface AdminPageProps {
  ...
  onSuspendUser: (email: string, reason: string) => void;
  onUnsuspendUser: (email: string) => void;
...
export function AdminPage({ 
  ...
  const handleAction = (item: Item, actionType: 'approve' | 'reject' | 'delete') => {
