              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                <Box
                  sx={{
                    width: 64,
                    height: 64,
                    background: 'linear-gradient(135deg, #800020 0%, rgba(128, 0, 32, 0.8) 100%)',
                    borderRadius: '50%',
                    display: 'flex',
                    alignItems: 'center',
            ...
            <Tabs value={activeTab} onChange={(_, newValue) => setActiveTab(newValue)} sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <Tab
                label={
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    Active
                    <Chip label={myReports.length} size="small" color="secondary" />
                  </Box>
                }
              />
              <Tab
                label={
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    Pending
                    <Chip label={myPending.length} size="small" color="secondary" />
                  </Box>
                }
              />
              <Tab
                label={
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    Claimed
                    <Chip label={myClaimed.length} size="small" color="secondary" />
                  </Box>
                }
              />
            </Tabs>
      ...
      <Dialog open={editDialogOpen} onClose={() => setEditDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, pt: 2 }}>
            {/* Account Info */}
            <Box>
              <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: '#800020' }}>
                Account Information
              </Typography>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Role: <strong>{userRole === 'admin' ? 'Administrator' : 'Student'}</strong>
                  </Typography>
                </Box>
              </Box>
            </Box>
            ...
            <Box>
              ...
              <Alert severity="warning" sx={{ mb: 2 }}>
                Deleting your account is permanent and cannot be undone. All your reports and data will be lost.
              </Alert>
              <Button
                variant="outlined"
                color="error"
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2 }}>
            <Alert severity="error">
              ...
              <Typography variant="body2">
                ...
                <br />
                • You will lose access to all notifications and claims
              </Typography>
            </Alert>
